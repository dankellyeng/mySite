...
export const PeopleInput = () => {
    ...
    const handleSubmit = (e: FormEvent<HTMLButtonElement>) =>{ 
        ...
        axios.post(`https://dark-star-7714.getsandbox.com/users`, { person }, options )
        .then(res => {
    ...
    <Styles>
       ...
       <Form>
        <Form.Label>
            Person Name:
            <Form.Control placeholder="Sign our guestbook"type="text" name="name" onChange={handleChange}></Form.Control>
        </Form.Label>
